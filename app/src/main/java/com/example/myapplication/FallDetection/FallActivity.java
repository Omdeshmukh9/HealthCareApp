...
public class FallActivity extends AppCompatActivity implements SensorEventListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent j = new Intent(FallActivity.this, Setting.class);
            startActivity(j);
            // return true;
        }
    ...
    public void onSensorChanged(final SensorEvent event) {
        ...
        if (min == true && max == true) {
            ...
            Intent test= new Intent(FallActivity.this, FallTest.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if(requestCode==2)
        {
            ...
            if(message>25)
            {
                Intent alert_intent=new Intent(FallActivity.this, Examples.class);
